...
export const actionTeacherAddSubject = createAction(
  async (payload: { sessionId: number; sectionId: number; subjectId: number }) => {
    await api.sdbms.teacher.subject.add(payload)
