...
export function FormSubmitButton(props: PropsWithChildren) {
  ...
  return (
    <Button className='group grid place-items-center' aria-disabled={pending} type='submit'>
      <LoaderCircleIcon className='col-start-1 row-start-1 size-5 text-primary-foreground transition-opacity group-not-aria-disabled:opacity-0 group-aria-disabled:animate-spin' />
