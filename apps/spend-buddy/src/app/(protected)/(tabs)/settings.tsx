...
function AppUpdateButton() {
  ...
  return (
    isChecking ? <SettingItem icon='update' label='Checking for updates...' disabled />
    : isUpdatePending ? <SettingItem icon='reload' label='Reload to update' onPress={reloadAsync} />
    : isDownloading ? <SettingItem icon='update' label='Downloading new updates...' disabled />
    : isUpdateAvailable ?
      <SettingItem
        icon='download'
