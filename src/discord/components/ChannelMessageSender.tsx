export default function ChannelMessageSender() {
  return (
    <form
      ...
      <label className="icon px-4 text-3xl text-slate-300">
      ...
      <div className="flex shrink-0 divide-x divide-slate-400/75 text-slate-300">
        <div className="space-x-2 px-4">
          <button className="icon text-3xl leading-none hover:text-slate-200" type="button">
            gif_box
          </button>
          <button className="icon text-3xl leading-none hover:text-slate-200" type="button">
            insert_emoticon
        ...
        <div className="px-4">
          <button
            className="icon text-3xl leading-none hover:text-slate-200 disabled:cursor-not-allowed disabled:text-slate-400"
            disabled>
            send
          </button>
        </div>
