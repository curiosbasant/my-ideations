        ...
        <>
          <div className='flex items-center divide-x divide-slate-500/75'>
            <div className='whitespace-nowrap pr-4 text-slate-300'>
              <span className='px-2 font-icon text-3xl leading-none'>person</span>
          ...
          <div className='ml-auto flex shrink-0 items-center divide-x divide-slate-500/75'>
            <div className='px-4'>
              <span className='font-icon text-3xl leading-none'>add_comment</span>
            </div>
            <div className='space-x-4 px-4'>
              <span className='font-icon text-3xl leading-none'>chat</span>
              <span className='font-icon text-3xl leading-none'>help</span>
            </div>
          </div>
        </>
      </PanelTop>
          ...
          <div className=''>
            <label className='relative block'>
              <input
                ...
                type='text'
              />
              <span className='absolute right-2 top-2 align-middle font-icon'>search</span>
            </label>
          </div>
      ...
      <div className='flex gap-4'>
        ...
        <div className='space-x-2'>
          <button className='h-10 w-10 rounded-full bg-slate-700 bg-opacity-75 group-hover:bg-opacity-100'>
            <span className='font-icon'>message</span>
          </button>
          <button className='h-10 w-10 rounded-full bg-slate-700 bg-opacity-75 group-hover:bg-opacity-100'>
            <span className='font-icon'>more_vert</span>
          </button>
        </div>
      </div>
    </li>
