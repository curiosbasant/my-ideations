          ...
          <ul className="space-y-1">
            ...
            {channels.map((ch) => (
              <li className="" key={ch.id}>
                <Link href={`@me/${ch.id}`} shallow>
                  <a className="group flex w-full items-center gap-4 rounded-md bg-slate-50 bg-opacity-0 py-1 px-2 text-slate-400 transition hover:bg-opacity-5 focus:bg-opacity-10">
